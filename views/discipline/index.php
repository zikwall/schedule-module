...
/* @var $searchModel humhub\modules\university\models\search\UniversityDisciplineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

?>
<?php $this->beginContent('@humhub/modules/schedule/views/layouts/_advancedLayout.php') ?>

<div class="university-discipline-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('UniversityModule.base', 'Create University Discipline'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
